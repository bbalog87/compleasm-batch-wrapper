...
Compleasm is a tool designed to assess the completeness of genome assemblies based BUSCO lineages. Developed by [Neng Huang and Heng Li](https://doi.org/10.1093/bioinformatics/btad595), Compleasm offers a faster and more accurate alternative to traditional methods like [BUSCO](https://busco.ezlab.org/).
